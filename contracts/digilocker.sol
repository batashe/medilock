...
contract digiLocker {
    ...
    function isValidSharableUser(string memory email_)
        public
        view
        returns (bool)
    {
    ...
    function getOwnerDocInfoByDocId(bytes32 docId)
        public
        view
    ...
    function getDocumetList(address _useradd)
        public
        view
        returns (
            string[] memory,
        ...
        )
    {
        ...
        for (uint256 i = 0; i < ownerDocuments[_useradd].length; i++) {
    ...
    function getDocumentListbyDocId(bytes32 _docId)
        public
        view
        returns (
            bytes32,
    ...
    function getAddressByEmail(string memory _email)
        public
        view
        returns (address)
    {
    ...
    function getEmailIdByUsrAddr(address _usraddrs)
        public
        view
        returns (
            string memory,
    ...
    function getDocIndex(bytes32 _docid_, address _uaddr_)
        public
        view
        returns (uint256)
    {
        for (uint256 i = 0; i < ownerDocuments[_uaddr_].length; i++) {
    ...
    function getDocumentName(bytes32 _docId, address docOwner)
        public
        view
        returns (string memory)
    {
        for (uint256 j = 0; j < ownerDocuments[docOwner].length; j++) {
